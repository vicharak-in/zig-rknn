...
pub const rknn_matmul_ctx = rknn_context;
...
pub extern fn rknn_matmul_set_io_mem(ctx: rknn_matmul_ctx, mem: [*c]rknn_tensor_mem, attr: [*c]rknn_matmul_tensor_attr) c_int;
pub extern fn rknn_matmul_set_core_mask(context: rknn_matmul_ctx, core_mask: rknn_core_mask) c_int;
...
pub const _rknn_matmul_quant_type = enum__rknn_matmul_quant_type;
pub const _rknn_quant_params = struct__rknn_quant_params;
pub const _rknn_matmul_type = enum__rknn_matmul_type;
pub const _rknn_matmul_tensor_attr = struct__rknn_matmul_tensor_attr;
pub const _rknn_matmul_io_attr = struct__rknn_matmul_io_attr;
pub const _rknn_matmul_shape = struct__rknn_matmul_shape;
pub const rknn_matmul_info_t = struct_rknn_matmul_info_t;
